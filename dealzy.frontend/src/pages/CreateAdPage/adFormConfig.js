  ...
  rent: [
    {
      ...
      items: [
        ...
        { key: 'bed',       label: 'Койко-место',         propertyKind: 'bed',       dealType: DEAL_TYPES.RENT },
        { key: 'house',     label: 'Дом, дача',           propertyKind: 'house',     dealType: DEAL_TYPES.RENT },
        { key: 'housePart', label: 'Часть дома',          propertyKind: 'housePart', dealType: DEAL_TYPES.RENT },
        { key: 'townhouse', label: 'Таунхаус',            propertyKind: 'townhouse', dealType: DEAL_TYPES.RENT },
  ...
  daily: [
    {
      ...
      items: [
        ...
        { key: 'bed',       label: 'Койко-место', propertyKind: 'bed',     dealType: DEAL_TYPES.DAILY },
      ],
    },
  ],
  buy: [
    {
      ...
      items: [
        ...
        { key: 'housePart',        label: 'Часть дома',             propertyKind: 'housePart', dealType: DEAL_TYPES.BUY },
        { key: 'townhouse',        label: 'Таунхаус',               propertyKind: 'townhouse', dealType: DEAL_TYPES.BUY },
    ...
    },
    {
      ...
      items: [
        ...
        { key: 'business',  label: 'Бизнес',              propertyKind: 'business',  dealType: DEAL_TYPES.COMMERCIAL_BUY },
      ],
    },
  ],
};
